...
//added
#define OLED4_Pin GPIO_PIN_11
#define OLED4_GPIO_Port GPIOD
#define OLED3_Pin GPIO_PIN_12
#define OLED3_GPIO_Port GPIOD
#define OLED2_Pin GPIO_PIN_13
#define OLED2_GPIO_Port GPIOD
#define OLED1_Pin GPIO_PIN_14
#define OLED1_GPIO_Port GPIOD
