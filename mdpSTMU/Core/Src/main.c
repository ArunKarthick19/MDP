...
/* USER CODE BEGIN PV */
	...
	int tc1, tc2;           // timer capture values
	int firstEdge = 0;      // edge detection flag
	float distance_cm = 0;  // measured distance in cm

	#define OBSTACLE_THRESHOLD_CM 20.0f  // Stop if obstacle within 20cm
	TIM_HandleTypeDef htim6;  // Add this with other timer handles at top
...
//		  }
		  ...
		  while (1) {
		      ...
		      // ... rest of your existing main loop code ...
		  }
//		  while (1) {
//
